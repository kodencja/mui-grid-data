...
const AboutInfo = () => {
    return (
        <Box sx={{ width: '100%', m: 1, textAlign: 'justify' }}>
            ...
            <Typography variant="body1" gutterBottom>For managing the form submition and error service (in AddRecord component) REACT FINAL FORM package is used. The API REQUESTS are served with AXIOS library.</Typography>
