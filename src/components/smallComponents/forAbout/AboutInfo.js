...
const AboutInfo = () => {
    return (
        <Box sx={{ width: '100%', m: 1, textAlign: 'justify' }}>
            ...
            <Typography variant="body1" gutterBottom color="text.primary">The code of the application may be see on my github account<Button
              variant="text"
              size="small"
              color="secondary"
              target="_blank"
