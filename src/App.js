...
import {fetchData, putData, postData, deleteData, deleteRows, set_if_to_del_row, set_row_params} from "./redux";
...
function App(props) {
  ...
  const {api_db: { data, loading, currentURLtoDB, baseURLtoDB, error }, grid_actions: {row_params, del_to_row}, fetchData, api_put, api_post, api_del, rows_del, set_if_to_del_row, set_row_params} = props;
